...
{
    public class FullSpeedStrategy : IServiceStrategy
    {
        ...
        #region Constructor
        public FullSpeedStrategy(ServiceBase Service)
        {
        ...
        public void GoToPlace()
        {
            ...
            Message += " van a atender una solicitud con celeridad!";
        ...
        public void Kill()
        {
            ...
            Console.WriteLine("No hay tiempo para bocata!");
            Console.WriteLine("Exterminando...");
            Thread.Sleep(1000);
